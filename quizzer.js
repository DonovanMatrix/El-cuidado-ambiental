...
var questions = [
	[
		"¿Cual es una de las causas de la contaminacion ambiental?",
		"La eleccion de malos presidentes",
		"El desarrollo industrial",
		"Falta de eduacion",
		"El medio amabiente se destruye solo",
		1
	],
	[
		"¿Cual es un daño ambiental causado por el desarrollo industrial?",
	...
	[
		"¿Cual de estas opciones es una repercusion negativa en el medio ambiente?",
	...
	[
		...
		"EL botar basura en la calles",
		"Quemar basura",
		"La tala indiscriminada de arboles",
		"Abusar de los aerosoles",
		2
	],
	[
		"¿Cual es la causa principal de la acumulacion de basura?",
		"El mal uso del celular",
		"La pandemia",
		"El desecho de materiales plasticos y biodegradables",
		"Falta de tachos de basura",
		2
	],
];
